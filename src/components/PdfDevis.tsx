      ...
      <View style={styles.sectionMontant}>
        <View style={styles.section1_montants}>
          <View style={styles.View_Tva}>
            <View style={styles.RowsTva}>
              ...
              <Text style={styles.ItemTva}>Montnant TVA (20%)</Text>
              <Text style={styles.ItemTva}>Montnant TVA (20%)</Text>
              <Text style={[styles.ItemTva, { borderRightWidth: 0 }]}>
                Montnant TVA (20%)
              </Text>
            </View>
            <View style={styles.RowsTva}>
              ...
              <Text style={styles.value_ItemTva}>0.00</Text>
              <Text style={[styles.value_ItemTva, { borderRightWidth: 0 }]}>
                0.00
              </Text>
            </View>
          </View>
        ...
        <View style={styles.section2_montants}>
          <View style={[styles.totals_titles]}>
            <Text style={[styles.item_total, { borderTopWidth: 0 }]}>
              TOTAL HT
            </Text>
            <Text style={[styles.item_total, { borderTopWidth: 0 }]}>
              TOTAL TVA
            ...
            <Text style={[styles.item_total, { borderBottomLeftRadius: 10 }]}>
              NET A PAYER
            </Text>
          </View>
          <View style={[styles.totals_titles, { borderRightWidth: 0 }]}>
            <Text style={[styles.item_value, { borderTopWidth: 0 }]}>
              54,17
            </Text>
            <Text style={[styles.item_value, { borderTopWidth: 0 }]}>
              10,83
